...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://env-account-sync.preview.emergentagent.com',
        'Referer': 'https://env-account-sync.preview.emergentagent.com/',
...
def test_http_404_registration_fix_critical(base_url):
    ...
    try:
        ...
        endpoints_to_test = [
            ...
            f"https://env-account-sync.preview.emergentagent.com/auth/register"
        ]
