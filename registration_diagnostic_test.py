...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://mobile-first-6.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://mobile-first-6.preview.emergentagent.com',
        'Referer': 'https://mobile-first-6.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://mobile-first-6.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://mobile-first-6.preview.emergentagent.com',
            'Referer': 'https://mobile-first-6.preview.emergentagent.com/auth',
