...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://mentionsfeed.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://mentionsfeed.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://mentionsfeed.preview.emergentagent.com',
            'Referer': 'https://mentionsfeed.preview.emergentagent.com/auth',
