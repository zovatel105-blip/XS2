...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://camera-profile-edit.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://camera-profile-edit.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://camera-profile-edit.preview.emergentagent.com',
            'Referer': 'https://camera-profile-edit.preview.emergentagent.com/auth',
