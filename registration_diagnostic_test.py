...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://profile-links-hub.preview.emergentagent.com',
        'Referer': 'https://profile-links-hub.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://profile-links-hub.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://profile-links-hub.preview.emergentagent.com',
            'Referer': 'https://profile-links-hub.preview.emergentagent.com/auth',
