...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://chatfixer.preview.emergentagent.com',
        'Referer': 'https://chatfixer.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://chatfixer.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://chatfixer.preview.emergentagent.com',
            'Referer': 'https://chatfixer.preview.emergentagent.com/auth',
