...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://mention-grid-app.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://mention-grid-app.preview.emergentagent.com',
        'Referer': 'https://mention-grid-app.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://mention-grid-app.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://mention-grid-app.preview.emergentagent.com',
            'Referer': 'https://mention-grid-app.preview.emergentagent.com/auth',
