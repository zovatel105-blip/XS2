...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://reliable-auth-1.preview.emergentagent.com',
        'Referer': 'https://reliable-auth-1.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://reliable-auth-1.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://reliable-auth-1.preview.emergentagent.com',
            'Referer': 'https://reliable-auth-1.preview.emergentagent.com/auth',
