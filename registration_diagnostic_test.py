...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://mobile-publish-1.preview.emergentagent.com/api"
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://mobile-publish-1.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://mobile-publish-1.preview.emergentagent.com',
            'Referer': 'https://mobile-publish-1.preview.emergentagent.com/auth',
