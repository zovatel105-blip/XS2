...
def get_backend_url():
    ...
    try:
        ...
        pass
    return "https://votatik.preview.emergentagent.com/api"
...
def get_mobile_headers():
    ...
    return {
        ...
        'Origin': 'https://votatik.preview.emergentagent.com',
        'Referer': 'https://votatik.preview.emergentagent.com/',
...
def test_registration_comprehensive():
    ...
    test_urls = [
        ...
        f"https://votatik.preview.emergentagent.com/api/auth/register",
    ...
    try:
        ...
        frontend_headers = {
            ...
            'Content-Type': 'application/json',
            'Origin': 'https://votatik.preview.emergentagent.com',
            'Referer': 'https://votatik.preview.emergentagent.com/auth',
