...
import { Home, Swords, Plus, Inbox, User, ChevronLeft, ChevronRight, Heart, MessageCircle, Share2, Bookmark, Volume2, VolumeX } from 'lucide-react';
import { cn } from '../lib/utils';
import { useAuth } from '../contexts/AuthContext';
import AppConfig from '../config/config';
import { Avatar, AvatarImage, AvatarFallback } from '../components/ui/avatar';

// Datos de ejemplo para los battles/streams
const mockBattles = [
  {
    id: '1',
    participants: [
...
const ExplorePage = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black overflow-hidden" ref={containerRef}>
      ...
      {/* Menú lateral derecho - estilo de la imagen de referencia */}
      <div 
      ...
      >
        ...
        {/* Crear - Botón especial con gradiente */}
        <button
