...
import { 
  Settings, Users, Vote, Trophy, Heart, Share, ArrowLeft, AtSign, Bookmark, LayoutGrid, Check, 
              ...
              >
                {isFollowing(viewedUser?.id || userId) ? (
                  <>
                    <span>Siguiendo</span>
                    <button
                      className="ml-1 p-1 hover:bg-green-400 rounded-full transition-colors text-green-800"
                      onClick={(e) => {
