  ...
  const getPlatformStyle = (name) => {
    ...
    const platforms = {
      ...
      'twyk': { 
        ...
        gradient: 'from-purple-600 via-blue-500 to-purple-400', 
        icon: (
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="min-h-screen bg-white">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        userHasStories && userStoriesData?.has_unviewed
                          ? "p-[3px] bg-gradient-to-tr from-[#00FFFF] via-[#8A2BE2] to-[#000000] cursor-pointer"
                          : userHasStories && !userStoriesData?.has_unviewed
          ...
          <div className="pb-24">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="px-1 sm:px-2 mb-1">
