  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6">
        ...
        <div className="bg-white rounded-xl p-3.5 sm:p-4 shadow-sm">
          <div className="flex items-center justify-between gap-3 sm:gap-4">
            ...
            {/* AVATAR EN EL CENTRO - IMAGEN DE PERFIL CON BORDE DEGRADADO (MÁS PEQUEÑO) */}
            <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-26 md:h-26 flex-shrink-0 mx-1.5 sm:mx-2">
              ...
              {/* Botón de acción "+" superpuesto en la parte inferior del avatar (MÁS PEQUEÑO) */}
              <button className="absolute -bottom-0.5 -right-0.5 w-7 h-7 sm:w-8 sm:h-8 md:w-8 md:h-8 bg-blue-500 hover:bg-blue-600 rounded-full flex items-center justify-center shadow-lg transition-all duration-200 active:scale-90 z-10">
